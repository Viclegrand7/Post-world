...
namespace Graphic {
	...
	public:
		...
		virtual bool update(bool tmp) {return true;}	//It looks stupid and IS stupid. But otherwhise copy of my displayedItems in Board gets rid of inheritance for 0 good reason
