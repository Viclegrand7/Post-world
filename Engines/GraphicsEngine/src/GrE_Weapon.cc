...
bool Graphic :: Weapon :: reload() {return false;}//Gun knows how to reload. We pretend being melee: NOTHING to be done

bool Graphic :: Weapon :: secondary() {//Gun knows how to aim. We pretend being melee: Strong attack
	if (!att_currentFrame) {
